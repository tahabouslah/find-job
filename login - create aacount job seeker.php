    ...
    <body>
        <div class="container">
            ...
            <div class="container-account">
                <!-- LOGO OF WEBSITE -->
                <div class="logo-web"><a href="./index.php">
                ...
                <div class="container-formulaire">
                        ...
                        <!-- FORMULAIRE -->
                        <form class="formulaire-create-account" action="includes/signupseek.inc.php" method="post">
                            <!-- CIN  -->
                            <input class="inptCin form-control" type="number" id="exampleFormControlInput-1"placeholder="CIN" name="cin"/>
                            <!-- FIRST NAME -->
                            ...
                            <!-- EMAIL -->
                            <input class="inptEmail form-control" type="email" id="exampleFormControlInput1" placeholder="name@example.com" name="adresse"/>
                            <!-- PASSWORD -->
                            <input class="inptPwd form-control" type="password" id="inputPassword" placeholder="Password" name="pw"/>
                            <!-- BUTTON CREATE -->
                            <button class="create-btn btn btn-dark" type="submit" name="submitt" onclick="seeker()">Create account</button>
